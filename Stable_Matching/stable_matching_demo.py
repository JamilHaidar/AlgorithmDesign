...
# https://github.com/JamilHaidar/Stable-Matching-Marriage-Problem
...
for n in range(min_n,max_n+1):
    ...
    for _ in range(monte_carlo):
        ...
        # men_preferences = {'0':['0','1','2','3'],'1':['1','0','3','2'],'2':['2','3','0','1'],'3':['3','2','1','0']}
        men_preferences = {'0':['0','1','2','3'],'1':['0','1','2','3'],'2':['0','1','2','3'],'3':['0','1','2','3']}
        # women_preferences = {str(idx):random.sample(seq,n) for idx in range(n)}
        women_preferences = {'0':['3','2','1','0'],'1':['3','2','1','0'],'2':['3','2','1','0'],'3':['3','2','1','0']}
        # women_preferences = {'0':['3','2','1','0'],'1':['2','3','0','1'],'2':['1','0','3','2'],'3':['0','1','2','3']}
        women_matches = {}
        men_matches = {}
        iterations = 0
